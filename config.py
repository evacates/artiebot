...
# Daily doodle list order follows insertion order in this mapping.
DAILY_DOODLE_THEMES = list(DAILY_DOODLE_THEME_EMOJIS.keys())

# Change this date tuple to reset the cycle start (YYYY, M, D) in UTC.
